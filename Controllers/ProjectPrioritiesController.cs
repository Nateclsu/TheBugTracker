...
namespace TheBugTracker.Controllers
{
    public class ProjectPrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyId,Name,Description")] ProjectPriority projectPriority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyId,Name,Description")] ProjectPriority projectPriority)
        {
